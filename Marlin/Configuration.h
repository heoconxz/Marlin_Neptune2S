...
#define STRING_CONFIG_H_AUTHOR "(Heoconxz, Elegoo Neptune 2/2s)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Elegoo 2S"
...
#define Z_MAX_ENDSTOP_HIT_STATE HIGH
  ...
  #define Z_MIN_ENDSTOP_HIT_STATE HIGH // Set to true to invert the logic of the endstop. *default = true Neptune 3 p.t.
#else
 ...
 */
#if ENABLED(IS_3D)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 138, 138 }
...
#else  
  #if ENABLED(HAS_EFIT)
    #define DEFAULT_MAX_FEEDRATE          { 200, 200, 10, 30 }  //1------最高速度
  #else
    #define DEFAULT_MAX_FEEDRATE          { 200, 200, 10, 60 }  //1------最高速度
  #endif
#endif 
 ...
 */
#if ENABLED(IS_3D)
  #define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 200, 3000, 3000 }  
#else
  #define DEFAULT_MAX_ACCELERATION    { 3000, 3000, 200, 3000} //1------最高加速度
#endif
 ...
 */
    ...
    #define NOZZLE_TO_PROBE_OFFSET { 40.0, -7.5, -1.1 } // my setup - P.T.
#else
...
#endif//#define AUTO_BED_LEVELING_UBL
#if NONE(HAS_BLTOUCH)
